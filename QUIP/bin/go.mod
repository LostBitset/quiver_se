module LostBitset/quiver_se/QUIP/bin

go 1.20

replace LostBitset/quiver_se/QUIP/lib => ../lib
...
require (
	...
	LostBitset/quiver_se/QUIP/lib v0.0.0-00010101000000-000000000000 // indirect
